class Permission {
  ...
  //  Candidte Profile
  static CANDIDATE_PROFILE_VIEW = "candidate_profile_view";
  static CANDIDATE_PROFILE_ADD = "candidate_profile_add";
  static CANDIDATE_PROFILE_EDIT = "candidate_profile_edit";
  static CANDIDATE_PROFILE_DELETE = "candidate_profile_delete";
  // Company Permissions
  ...
  //Quick Links 
  static QUICK_LINKS = "quick_links";
  ...
  static TRANSFER_PRODUCT_VIEW = "transfer_product_view";
  ...
  static UserPermissionLists() {
    return [
      ...
      {
        label: this.SALE_EDIT,
        value: this.SALE_EDIT,
      },
      {
        label: this.SALE_DELETE,
        value: this.SALE_DELETE,
      },
      {
        label: this.SALE_VIEW,
        value: this.SALE_VIEW,
      },
      {
        label: this.SALE_STATUS_UPDATE,
        value: this.SALE_STATUS_UPDATE,
      },
      {
      ...
      {
        label: this.TRANSFER_PRODUCT_VIEW,
        value: this.TRANSFER_PRODUCT_VIEW,
      },
      {
  ...
  static permissionList = [
    ...
    },
    {
      title: "Sale",
      permission: [
        { name: this.SALE_VIEW, label: "Sale View" },
        { name: this.SALE_ADD, label: "Sale Add" },
        { name: this.SALE_EDIT, label: "Sale Edit" },
        { name: this.SALE_DELETE, label: "Sale Delete" },
        { name: this.SALE_STATUS_UPDATE, label: "Sale Status Update" },
        { name: this.SALE_MANAGE_OTHERS, label: "Sale Manage Others" },
      ],
    },
    {
      title: "Location",
